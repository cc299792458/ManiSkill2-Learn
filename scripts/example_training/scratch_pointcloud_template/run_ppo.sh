...
python maniskill2_learn/apis/run_rl.py configs/mfrl/ppo/maniskill2_state.py \
            --work-dir /chichu-slow-vol/PickCube-v3 --gpu-ids 0 \
            --cfg-options "env_cfg.env_name=PickCube-v3" "env_cfg.obs_mode=state" \
            "env_cfg.reward_mode=dense" "env_cfg.control_mode=constvel_ee_delta_pose" \
            "eval_cfg.num=100" "eval_cfg.save_traj=False" "eval_cfg.save_video=True" 
